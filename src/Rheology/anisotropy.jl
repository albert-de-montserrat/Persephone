...
function directRotation(R,C)
    @fastmath begin
        ...
        # n12 = 4 * ((e * x3 * y3 + f * x2 * y2) * x1 * y1 + d * x2 * x3 * y2 * y3) + (h * x1 ^ 2 + l * x2 ^ 2 + c * x3 ^ 2) * y3 ^ 2 + (g * x2 ^ 2 + h * x3 ^ 2 + a * x1 ^ 2) * y1 ^ 2 + (g * x1 ^ 2 + l * x3 ^ 2 + b * x2 ^ 2) * y2 ^ 2
        n13 = 4 * ((e * x3 * z3 + f * x2 * z2) * x1 * z1 + d * x2 * x3 * z2 * z3) + (h * x1 ^ 2 + l * x2 ^ 2 + c * x3 ^ 2) * z3 ^ 2 + (g * x2 ^ 2 + h * x3 ^ 2 + a * x1 ^ 2) * z1 ^ 2 + (g * x1 ^ 2 + l * x3 ^ 2 + b * x2 ^ 2) * z2 ^ 2
        # n14 = 2 * (((x2 * z3 + x3 * z2) * e * x1 + (y2 * z3 + y3 * z2) * d * x2) * x3 + (x2 * y3 + x3 * y2) * f * x1 * x2) + (h * x1 ^ 2 + l * x2 ^ 2 + c * x3 ^ 2) * y3 * z3 + (g * x2 ^ 2 + h * x3 ^ 2 + a * x1 ^ 2) * y1 * z1 + (g * x1 ^ 2 + l * x3 ^ 2 + b * x2 ^ 2) * y2 * z2
        ...
        # n16 = 2 * (((x1 * z2 + x2 * z1) * e * x1 + (y1 * z2 + y2 * z1) * d * x2) * x3 + (x1 * y2 + x2 * y1) * f * x1 * x2) + (h * x1 ^ 2 + l * x2 ^ 2 + c * x3 ^ 2) * x3 * y3 + (g * x2 ^ 2 + h * x3 ^ 2 + a * x1 ^ 2) * x1 * y1 + (g * x1 ^ 2 + l * x3 ^ 2 + b * x2 ^ 2) * x2 * y2
        # n22 = 4 * ((e * y3 ^ 2 + f * y2 ^ 2) * y1 ^ 2 + d * y2 ^ 2 * y3 ^ 2) + (h * y1 ^ 2 + l * y2 ^ 2 + c * y3 ^ 2) * y3 ^ 2 + (g * y2 ^ 2 + h * y3 ^ 2 + a * y1 ^ 2) * y1 ^ 2 + (g * y1 ^ 2 + l * y3 ^ 2 + b * y2 ^ 2) * y2 ^ 2
        # n23 = 4 * ((e * y3 * z3 + f * y2 * z2) * y1 * z1 + d * y2 * y3 * z2 * z3) + (h * y1 ^ 2 + l * y2 ^ 2 + c * y3 ^ 2) * z3 ^ 2 + (g * y2 ^ 2 + h * y3 ^ 2 + a * y1 ^ 2) * z1 ^ 2 + (g * y1 ^ 2 + l * y3 ^ 2 + b * y2 ^ 2) * z2 ^ 2
        # n24 = 2 * (((x2 * z3 + x3 * z2) * e * y1 + (y2 * z3 + y3 * z2) * d * y2) * y3 + (x2 * y3 + x3 * y2) * f * y1 * y2) + (h * y1 ^ 2 + l * y2 ^ 2 + c * y3 ^ 2) * y3 * z3 + (g * y2 ^ 2 + h * y3 ^ 2 + a * y1 ^ 2) * y1 * z1 + (g * y1 ^ 2 + l * y3 ^ 2 + b * y2 ^ 2) * y2 * z2
        # n25 = 2 * (((x1 * z3 + x3 * z1) * e * y1 + (y1 * z3 + y3 * z1) * d * y2) * y3 + (x1 * y3 + x3 * y1) * f * y1 * y2) + (h * y1 ^ 2 + l * y2 ^ 2 + c * y3 ^ 2) * x3 * z3 + (g * y2 ^ 2 + h * y3 ^ 2 + a * y1 ^ 2) * x1 * z1 + (g * y1 ^ 2 + l * y3 ^ 2 + b * y2 ^ 2) * x2 * z2
        # n26 = 2 * (((x1 * z2 + x2 * z1) * e * y1 + (y1 * z2 + y2 * z1) * d * y2) * y3 + (x1 * y2 + x2 * y1) * f * y1 * y2) + (h * y1 ^ 2 + l * y2 ^ 2 + c * y3 ^ 2) * x3 * y3 + (g * y2 ^ 2 + h * y3 ^ 2 + a * y1 ^ 2) * x1 * y1 + (g * y1 ^ 2 + l * y3 ^ 2 + b * y2 ^ 2) * x2 * y2
        n33 = 4 * ((e * z3 ^ 2 + f * z2 ^ 2) * z1 ^ 2 + d * z2 ^ 2 * z3 ^ 2) + (h * z1 ^ 2 + l * z2 ^ 2 + c * z3 ^ 2) * z3 ^ 2 + (g * z2 ^ 2 + h * z3 ^ 2 + a * z1 ^ 2) * z1 ^ 2 + (g * z1 ^ 2 + l * z3 ^ 2 + b * z2 ^ 2) * z2 ^ 2
        # n34 = 2 * (((x2 * z3 + x3 * z2) * e * z1 + (y2 * z3 + y3 * z2) * d * z2) * z3 + (x2 * y3 + x3 * y2) * f * z1 * z2) + (h * z1 ^ 2 + l * z2 ^ 2 + c * z3 ^ 2) * y3 * z3 + (g * z2 ^ 2 + h * z3 ^ 2 + a * z1 ^ 2) * y1 * z1 + (g * z1 ^ 2 + l * z3 ^ 2 + b * z2 ^ 2) * y2 * z2
        ...
        # n36 = 2 * (((x1 * z2 + x2 * z1) * e * z1 + (y1 * z2 + y2 * z1) * d * z2) * z3 + (x1 * y2 + x2 * y1) * f * z1 * z2) + (h * z1 ^ 2 + l * z2 ^ 2 + c * z3 ^ 2) * x3 * y3 + (g * z2 ^ 2 + h * z3 ^ 2 + a * z1 ^ 2) * x1 * y1 + (g * z1 ^ 2 + l * z3 ^ 2 + b * z2 ^ 2) * x2 * y2
        # n44 = (x2 * z3 + x3 * z2) ^ 2 * e + (y2 * z3 + y3 * z2) ^ 2 * d + (x2 * y3 + x3 * y2) ^ 2 * f + (h * y1 * z1 + l * y2 * z2 + c * y3 * z3) * y3 * z3 + (g * y2 * z2 + h * y3 * z3 + a * y1 * z1) * y1 * z1 + (g * y1 * z1 + l * y3 * z3 + b * y2 * z2) * y2 * z2
        # n45 = (x1 * z3 + x3 * z1) * (x2 * z3 + x3 * z2) * e + (y1 * z3 + y3 * z1) * (y2 * z3 + y3 * z2) * d + (x1 * y3 + x3 * y1) * (x2 * y3 + x3 * y2) * f + (h * y1 * z1 + l * y2 * z2 + c * y3 * z3) * x3 * z3 + (g * y2 * z2 + h * y3 * z3 + a * y1 * z1) * x1 * z1 + (g * y1 * z1 + l * y3 * z3 + b * y2 * z2) * x2 * z2
        # n46 = (x1 * z2 + x2 * z1) * (x2 * z3 + x3 * z2) * e + (y1 * z2 + y2 * z1) * (y2 * z3 + y3 * z2) * d + (x1 * y2 + x2 * y1) * (x2 * y3 + x3 * y2) * f + (h * y1 * z1 + l * y2 * z2 + c * y3 * z3) * x3 * y3 + (g * y2 * z2 + h * y3 * z3 + a * y1 * z1) * x1 * y1 + (g * y1 * z1 + l * y3 * z3 + b * y2 * z2) * x2 * y2
        ...
        # n56 = (x1 * z2 + x2 * z1) * (x1 * z3 + x3 * z1) * e + (y1 * z2 + y2 * z1) * (y1 * z3 + y3 * z1) * d + (x1 * y2 + x2 * y1) * (x1 * y3 + x3 * y1) * f + (h * x1 * z1 + l * x2 * z2 + c * x3 * z3) * x3 * y3 + (g * x2 * z2 + h * x3 * z3 + a * x1 * z1) * x1 * y1 + (g * x1 * z1 + l * x3 * z3 + b * x2 * z2) * x2 * y2
        # n66 = (x1 * z2 + x2 * z1) ^ 2 * e + (y1 * z2 + y2 * z1) ^ 2 * d + (x1 * y2 + x2 * y1) ^ 2 * f + (h * x1 * y1 + l * x2 * y2 + c * x3 * y3) * x3 * y3 + (g * x2 * y2 + h * x3 * y3 + a * x1 * y1) * x1 * y1 + (g * x1 * y1 + l * x3 * y3 + b * x2 * y2) * x2 * y2
    end

    # return @SMatrix [n11 n12 n13 n14 n15 n16
